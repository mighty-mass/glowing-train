define(["exports"], function (t) {
  ...
  function C(t, e) {
    ...
    if (
      !(s in (n ? IDBIndex : IDBObjectStore).prototype) || !r && !B.includes(s)
    ) return;
  ...
  q = ((t) =>
    d({}, t, {
      get: (e, s, n) => C(e, s) || t.get(e, s, n),
      has: (e, s) => !!C(e, s) || t.has(e, s),
    }))(q);
  try {
  ...
  class P {
    ...
    async getTimestamp(t) {
      const e = await this.getDb(), s = await e.get(N, this.m(t));
      return null == s ? void 0 : s.timestamp;
    }
    async expireEntries(t, e) {
      const s = await this.getDb();
      let n = await s.transaction(N).store.index("timestamp").openCursor(
        null,
        "prev",
      );
      const r = [];
  ...
  class M {
    ...
    async expireEntries() {
      ...
      this.v = !1, this.D && (this.D = !1, f(this.expireEntries()));
    }
    ...
    async isURLExpired(t) {
      if (this.R) {
        const e = await this.B.getTimestamp(t), s = Date.now() - 1e3 * this.R;
        return void 0 === e || e < s;
      }
      return !1;
    }
  ...
  class A {
    ...
    async fetch(t) {
      ...
      try {
        ...
        t = await fetch(
          n,
          "navigate" === n.mode ? void 0 : this._.fetchOptions,
        );
    ...
    async cacheMatch(t) {
      const e = S(t);
      let s;
      const { cacheName: n, matchOptions: r } = this._,
    ...
    async cachePut(t, e) {
      ...
      if (!o) return !1;
      const { cacheName: c, matchOptions: h } = this._,
        ...
        f = l
          ? await async function (t, e, s, n) {
            ...
            const i = Object.assign(Object.assign({}, n), { ignoreSearch: !0 }),
              a = await t.keys(e, i);
            for (const e of a) if (r === U(e.url, s)) return t.match(e, n);
    ...
    hasCallback(t) {
      for (const e of this._.plugins) if (t in e) return !0;
      return !1;
    }
    ...
    async doneWaiting() {
      for (; this.C.length;) {
        const t = this.C.splice(0),
          e = (await Promise.allSettled(t)).find((t) =>
            "rejected" === t.status
          );
        if (e) throw e.reason;
      }
  ...
  t.ExpirationPlugin = class {
    ...
    S(t) {
      ...
      let e = this.L.get(t);
      return e || (e = new M(t, this.A), this.L.set(t, e)), e;
    }
    W(t) {
      if (!this.R) return !0;
      const e = this.F(t);
    ...
    async deleteCacheAndMetadata() {
      for (const [t, e] of this.L) {
        await self.caches.delete(t), await e.delete();
      }
      this.L = new Map();
    }
  },
    t.NetworkFirst = class extends L {
      constructor(t = {}) {
        super(t),
          this.plugins.some((t) => "cacheWillUpdate" in t) ||
          this.plugins.unshift(T),
          this.H = t.networkTimeoutSeconds || 0;
      }
      async U(t, e) {
        const n = [], r = [];
        let i;
        if (this.H) {
          const { id: s, promise: a } = this.$({
            request: t,
            logs: n,
            handler: e,
          });
        ...
        const a = this.K({ timeoutId: i, request: t, logs: n, handler: e });
        r.push(a);
      ...
      async K({ timeoutId: t, request: e, logs: s, handler: n }) {
        let r, i;
        try {
...
//# sourceMappingURL=workbox-e22bfc60.js.map
